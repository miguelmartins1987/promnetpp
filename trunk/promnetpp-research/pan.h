...
#define nstates1	76	/* :init: */
#define minseq1	155
#define maxseq1	229
#define endstate1	75

#define nstates0	156	/* Process */
#define minseq0	0
#define maxseq0	154
...
struct process_state { /* user defined type */
	uchar received_message[3];
	uchar view[3];
	uchar local_value;
	uchar decision_value;
};
...
typedef struct P1 { /* :init: */
	...
	uchar i;
	uchar j;
	uchar remaining_asynchronous_rounds;
} P1;
#define Air1	(sizeof(P1) - Offsetof(P1, remaining_asynchronous_rounds) - 1*sizeof(uchar))
